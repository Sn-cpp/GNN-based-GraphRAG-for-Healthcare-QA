...
class RebelExtractor:
    """
    Utilize REBEL model to extract triplets (subject, relation, object) from sentence
    """

    def __init__(self, model_name="Babelscape/rebel-large", device=torch.device('cpu')):
        self.device = device
    ...
    def parse_output(self, text: str):
        ...
        return [(s, r, o) for (s, r, o) in triplets if s != o]